    ...
    with sync_playwright() as p:
        ...
        for page_num in range(10):
            ...
            for hotel in hotels:
                ...
                try:
                    reviews_text = hotel.locator('//div[@data-testid="review-score"]/div[2]/div[2]').inner_text()
                    hotel_dict['reviews count'] = reviews_text.split()[0]
                except:
